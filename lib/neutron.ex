defmodule Neutron do
  ...
  # @spec create_async_producer(String.t(), atom(), GenServer.options()) ::
  ...
  @spec produce(String.t(), String.t(), keyword()) :: :ok | {:error, String.t()}
  def produce(topic, payload, produce_opts \\ []) do
    with [producer] <- Registry.lookup(Neutron.ProducerRegistry, topic) do
    else
      # create producer
      [] ->
        nil
