defmodule NeutronTest do
  ...
  test "async produce is always successful" do
    ...
    # IO.puts("************************* start stopping producer")
    # # :timer.sleep(3_000)
    # IO.puts("************************* start stopping producer 2")
    # Neutron.Application.terminate_child(pid)
    # :timer.sleep(3_000)
    # IO.puts("************************* end stopping producer")

    # IO.puts("************************* start sleeping")
    # :timer.sleep(5_000)
    # IO.puts("************************* end sleeping")
  end
